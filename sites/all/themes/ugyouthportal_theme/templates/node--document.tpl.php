...
$original_filename_parts = explode('.', $field_pdf_file[0]['filename']);
...
$link_download = '<a class="download btn btn-icon" download="'.$download_filename.'" href="'.$pdf_path.'" title="Download this video" id="download-video">Download</a>';
